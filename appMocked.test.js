...
mockedValidatePassword.mockImplementation(password => password.length >= 8);

const mockedValidateUsername = jest.fn();
mockedValidateUsername.mockImplementation(username => username.length >= 6 && username.length <= 30);
